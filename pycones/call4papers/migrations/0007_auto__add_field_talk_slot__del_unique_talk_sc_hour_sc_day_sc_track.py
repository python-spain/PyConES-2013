...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Talk.slot'
        db.add_column('call4papers_talk', 'slot',
                      self.gf('django.db.models.fields.CharField')(max_length=4, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Talk.slot'
        db.delete_column('call4papers_talk', 'slot')
    ...
    models = {
        ...
        'call4papers.talk': {
            ...
            'slot': ('django.db.models.fields.CharField', [], {'max_length': '4', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
