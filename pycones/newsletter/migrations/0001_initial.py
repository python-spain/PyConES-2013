...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('newsletter_subscription', (
            ...
            ('newsletter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['newsletter.Newsletter'])),
        ))
        db.send_create_signal('newsletter', ['Subscription'])

        # Adding unique constraint on 'Subscription', fields ['user', 'newsletter']
        db.create_unique('newsletter_subscription', ['user_id', 'newsletter_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subscription', fields ['user', 'newsletter']
        db.delete_unique('newsletter_subscription', ['user_id', 'newsletter_id'])
    ...
    models = {
        ...
        'newsletter.subscription': {
            'Meta': {'unique_together': "(('user', 'newsletter'),)", 'object_name': 'Subscription'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'newsletter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subscriptions'", 'to': "orm['newsletter.Newsletter']"}),
