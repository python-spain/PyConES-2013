...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.admin'
        db.add_column('newsletter_subscription', 'admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.admin'
        db.delete_column('newsletter_subscription', 'admin')
    ...
    models = {
        ...
        'newsletter.newsletter': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'79802006-b1b3-11e2-b959-0025d35aac78'", 'max_length': '255'})
        },
